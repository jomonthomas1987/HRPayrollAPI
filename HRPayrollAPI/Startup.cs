    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AddEntityFrameworkStores<PayrollDBContext>();
            ...
            services.AddScoped<IEmployeeMethod, EmployeeMethods>();
            services.AddControllers();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "HRPayrollAPI", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "HRPayrollAPI v1");
